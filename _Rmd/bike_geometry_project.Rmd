...
#  axle_crown_mean <- mean(bike[, axle_crown_est])
  ...
  # sag estimate
  bike[fork_travel == 80, fork_sag_est := (486 - axle_crown_est)/80*100]
  bike[fork_travel == 100, fork_sag_est := (506 - axle_crown_est)/100*100]
  bike[fork_travel == 120, fork_sag_est := (530 - axle_crown_est)/120*100]
  bike[fork_travel == 130, fork_sag_est := (540 - axle_crown_est)/130*100]
