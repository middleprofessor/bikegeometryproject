...
# mtbikes
    bike_i[!is.na(suspension_corrected) & axle_crown > 471,
           fork_class := paste(suspension_corrected, "mm")]
    
    bike_i[is.na(fork_class) &
             fork == "rigid" &
             axle_crown >= 471 &
             axle_crown < 489, fork_class := "100 mm"]
    bike_i[is.na(fork_class) &
             fork == "rigid" &
             axle_crown >= 489 &
             axle_crown < 513, fork_class := "120 mm"]
    bike_i[is.na(fork_class) &
             fork == "rigid" &
             axle_crown >= 513, fork_class := "130 mm"]

        # make a factor and order
    fork_classes <- c("0 mm", "20 mm", "30 mm", "40 mm", "50 mm", "60 mm", "100 mm", "110 mm", "120 mm", "130 mm")
