...
# tt + st + stack + reach + hta + sta + fc + cs + ht + ac = 0.906
  ...
  # random forest
#  x_cols <- c(x_cols, "frame_size_numeric")
...
import_bike_list <- function(style = "gravel", exchange_rates){
  ...
  # gravel
  # sc gravel
  # mountain: flat bar + 2.2 + boost
  # drop-bar mountain: drop bar + 2.2 + boost
  # atb: flat bar + 2.2 - boost
  # drop-bar atb: drop bar + 2.2 - boost
  # gravel: drop bar - 2.2 - boost
  # flat-bar gravel: drop bar - 2.2 - boost
  geobike[handlebar == "flat bar" &
            tire_width_max_700c >= 2.2 * 25.4 &
            rear_axle == "148",
          class := "MTB"]
