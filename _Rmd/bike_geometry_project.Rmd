...
effective_tt_check <- function(geobike){
  geobike[, top_tube_effective_est := layback + reach]
  geobike[, top_tube_diff := top_tube_effective_est - top_tube_effective_length]
  geobike[abs(top_tube_diff) > 2,
          .SD, .SDcols = c("model", "frame_size", "top_tube_effective_est", "top_tube_effective_length", "top_tube_diff")] |> View()
}
