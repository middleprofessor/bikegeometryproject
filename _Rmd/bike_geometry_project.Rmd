...
stack_sus_columns <- function(dt){
  ...
  # test columns
  sus_dt[, travel := substr(fork,1,2)]
  sus_dt[travel == "0 ", travel := "rigid"]
  sus_dt[substr(fork,1,2) == "0 ", travel2 := "rigid"]
  sus_dt[substr(fork,1,2) == "30", travel2 := "30 mm"]
  sus_dt[substr(fork,1,2) == "40", travel2 := "40 mm"]
  sus_dt[substr(fork,1,2) == "50", travel2 := "50 mm"]
  sus_dt[substr(fork,1,2) == "0 ", travel3 := "rigid"]
  sus_dt[substr(fork,1,2) == "30", travel3 := "thirty"]
  sus_dt[substr(fork,1,2) == "40", travel3 := "forty"]
  sus_dt[substr(fork,1,2) == "50", travel3 := "fifty"]
  sus_dt[, travel4 := factor(travel3)]
