...
# set up check boxes
  ...
  boxes <- filter_checkbox("fork", "Fork", geobike_sus_shared, ~travel2, inline = FALSE)
  bscols(widths = c(8,3), p1, boxes)
  bscols( widths = c(8,3), p2)
 
  boxes <- filter_checkbox("fork", "Fork", geobike_sus_shared, ~travel3, inline = FALSE)
  bscols(widths = c(8,3), p1, boxes)
  bscols( widths = c(8,3), p2)
 
  boxes <- filter_checkbox("fork", "Fork", geobike_sus_shared, ~travel4, inline = FALSE)
  bscols(widths = c(8,3), p1, boxes)
  bscols( widths = c(8,3), p2)
