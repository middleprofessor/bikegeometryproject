...
[Click here to see a version of this page that highlights single frame sizes within a model](../qmd/gravel_scatter.qmd)
...
```{r, warning=FALSE, message=FALSE, evale = FALSE, echo=FALSE, out.width = "90%", out.height = "90%"}
