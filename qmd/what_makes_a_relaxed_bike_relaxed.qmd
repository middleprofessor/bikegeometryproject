...
kmeans_class <- 3
mclust_class <- 4
relaxed_col <- c("relaxed", "relaxed_ternary", "kmeans_relaxed_score", "mclust_relaxed")[mclust_class]
...
p5 <- scatter_fig_global(data = geobike_shared,
                  y_col = relaxed_col, x_col = "fork_offset_rake",
...
### Headtube angle, seattube angle, fork offset, and trail aren't really related to relaxedness
