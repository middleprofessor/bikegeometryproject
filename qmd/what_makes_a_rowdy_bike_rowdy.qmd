...
kmeans_class <- 3
mclust_class <- 4
rowdy_col <- c("rowdy", "rowdy_ternary", "kmeans_rowdy_score", "mclust_rowdy")[mclust_class]
color_col <- c("restyle", "functional_style", "kmeans_style", "mclust_style")[mclust_class]
...
p5 <- scatter_fig_global(data = geobike_shared,
                  y_col = rowdy_col, x_col = "fork_offset_rake",
