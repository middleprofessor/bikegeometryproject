...
The [Which bikes are racy/rowdy/relaxed?](qmd/gravel_style_plot.qmd) page contains interactive plots for all gravel bike models in the database. Click on the points for finding bikes in the style you're seeking.
