...
subtitle: "A component of the gravelRRR multiverse"
---
...
The [Gravel Ternary](qmd/gravel_scatter.qmd) page contains an interactive, ternary plot for all gravel bike models in the database. Each ternary plot axis is a style score (0 -- 100) for one of the styles: Racy, Relaxed, and Rowdy.
